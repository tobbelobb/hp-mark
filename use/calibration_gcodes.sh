...
curl --silent -X GET -H "application/json, text/plain, */*" http://hp4test.local/rr_gcode?gcode=G95%20A15%20B5%20C5%20D24 >/dev/null # G95 A15 B5  C5  D24. Brings her closer to xy=(0,0)
