...
# Run hpm
readonly COMMAND="${HPMPATH}/hpm/hpm ${BINPATH}/openscadHandCodedCamParamsSixtupled.xml ${BINPATH}/grid-check-marker-params.xml ${HPMPATH}/hpm/test-images/grid-red-2000.png --no-filter-by-distance"
